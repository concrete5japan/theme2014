<?php
	...
	if (count($cArray) > 0) { ?>
	<ul class="ccm-page-list topPageList">
	...
	<li class="ccm-page-list-title"><a <?php if ($target != '') { ?> target="<?php echo $target?>" <?php } ?> href="<?php echo $nh->getLinkToCollection($cobj)?>"><?php echo $title?></a><?php if ($childrenNum !== '0') { echo ' (' . $childrenNum . ')'; } ?></li>	
<?php  } 
